...
export const en = {
  ...
  createEvent: {
    ...
    locationPlaceholder: "Office, cafe, room name...",
    onlineMeetingLabel: "Online meeting",
    meetingLinkLabel: "Meeting link",
    meetingLinkPlaceholder: "https://meet.example.com/team-sync",
  ...
  validation: {
    eventCreate: {
      ...
      locationMax: "Location must be 160 characters or fewer.",
      meetingLinkMax: "Meeting link must be 2048 characters or fewer.",
      meetingLinkUrl: "Use a full meeting link including http:// or https://.",
...
export const de: Messages = {
  ...
  createEvent: {
    ...
    eventFormatLabel: "Event-Format",
    inPersonLabel: "Vor Ort",
    locationLabel: "Ort",
    locationPlaceholder: "Büro, Café, Raumname...",
    onlineMeetingLabel: "Online-Meeting",
    meetingLinkLabel: "Meeting-Link",
    meetingLinkPlaceholder: "https://meet.example.com/team-sync",
  ...
  validation: {
    eventCreate: {
      ...
      locationMax: "Der Ort darf höchstens 160 Zeichen lang sein.",
      meetingLinkMax: "Der Meeting-Link darf höchstens 2048 Zeichen lang sein.",
      meetingLinkUrl:
        "Bitte verwende einen vollständigen Meeting-Link inklusive http:// oder https://.",
