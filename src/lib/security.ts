...
function getLocalizedAppErrorMessage(
  ...
  const templates: Record<string, string> = {
    ...
    too_many_dates: messages.errors.app.tooManyDates,
    invalid_day_window: messages.errors.app.invalidDayWindow,
    schedule_no_valid_meeting_window: messages.errors.app.scheduleNoValidMeetingWindow,
    full_day_date_unavailable: messages.validation.eventCreate.fullDayDateUnavailable,
    full_day_start_unavailable: messages.validation.eventCreate.fullDayStartUnavailable,
    schedule_changed: messages.errors.app.scheduleChanged,
    schedule_preview_stale: messages.errors.app.schedulePreviewStale,
